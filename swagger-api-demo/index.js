...
app.put('/items/:id',authenticateToken, (req, res) => {
  ...
  if(studentIndex !== -1){
    ...
    res.status(404).json({message: `No se encontro el estudiante con ID${id}`})
  }
});
...
app.get('/items/:id', authenticateToken, (req, res) => {
  ...
  if(student){
    ...
    res.status(404).json({ message: `No se encotro aldun estudiante con ID ${id} validar` });
  }
});
